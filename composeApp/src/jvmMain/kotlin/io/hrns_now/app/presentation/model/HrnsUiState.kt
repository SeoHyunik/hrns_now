...
data class RegistryProjectItem(
    ...
    /** "기본 Harness Kit" 또는 "외부 Harness Kit" — 기존 external project도 명확히 구분한다. */
...
sealed interface HrnsUiState {
    ...
    data class Ready(
        ...
        /** 오늘 날짜다 — 아직 daily directory가 없어도 오늘 시작을 안내하는 데 쓴다. */
        val todayDate: LocalDate,
        val activeProjectSourceLabel: String,
        val registryMessage: String?,
        /** "진단 후 등록"의 진행/결과다 — modal 안에서 직접 렌더링한다. */
         ...
         * 때만 true다. 이 값이 true인 동안만 Setup 화면이 Health Check와 구분되는

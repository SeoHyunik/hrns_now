...
fun UiAction.displayLabel(): String =
    when (this) {
        ...
        UiAction.EditRequest -> "요청 작성"
        UiAction.RunDoctor -> "상태 점검 실행"
        UiAction.RunOpsValidation -> "운영 검증 실행"
        UiAction.BootstrapDay -> "오늘 준비"
        ...
        UiAction.ViewExecutionStatus -> "실행 현황 보기"
    }

...
/** 개별 bridge 파일의 read-only 확인 결과다. write는 절대 하지 않는다(Phase 10). */
 ...
 * (`D:\harness-kit\docs\PROJECT_ONBOARDING.md` §4.1). Doctor/validate-ops는 bridge generator가
 * 아니므로 이 값은 오직 [io.hrns_now.core.port.RepositoryBridgeProbePort]로만 채워진다.
 */

 ...
 * 따르되, 어떤 PowerShell 명령으로도 직접 매핑하지 않는다. 실제 command 인코딩은
 * `HarnessCommandEncoder`가 이 값을 typed command로 변환할 때 이뤄진다.
 *
 ...
 * 실제 mapping은 live 계약이 확정된 뒤 연결한다.
 */
sealed interface UiAction {
     ...
     * live 계약 검토 전까지 process command와 연결하지 않는다.
     */
